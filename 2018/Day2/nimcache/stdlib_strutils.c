...
/* Command for C compiler:
   clang -c  -w  -I/usr/local/Cellar/nim/0.18.0_1/nim/lib -o /Users/bweyl/Documents/PythonCoding/AdventOfCode/2018/Day2/nimcache/stdlib_strutils.o /Users/bweyl/Documents/PythonCoding/AdventOfCode/2018/Day2/nimcache/stdlib_strutils.c */
...
STRING_LITERAL(TM_JGc9b9bh2D3nTdUR7TGyq8aA_13, "len(a) == L string modified while iterating over it", 51);
		...
		L = (s ? s->Sup.len : 0);
		{
			while (1) {
				...
				i += ((NI) 1);
				{
					...
					failedAssertImpl_aDmpBTs9cPuXp0Mp9cfiNeyA(((NimStringDesc*) &TM_JGc9b9bh2D3nTdUR7TGyq8aA_13));
				}
				LA10_: ;
			} LA3: ;
		}
